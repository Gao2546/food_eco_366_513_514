...
if __name__ == '__main__':
    original_image_dir = '/home/athip/psu/3/ecosys/food/food_segmentation.v3i.coco-segmentation/test'  # Where your original images are stored
    json_file = '/home/athip/psu/3/ecosys/food/food_segmentation.v3i.coco-segmentation/test/_annotations.coco.json'
    mask_output_folder = 'val2/masks2'  # Modify this as needed. Using val2 so my data is not overwritten
    image_output_folder = 'val2/images2'  # 
